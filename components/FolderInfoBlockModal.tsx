...
export default function FolderInfoBlockModal(props: any) {
  const language = 'UA'
  const family: any = useSelector((state: RootState) => state.family)

  const [name, setName] = useState<string>(family.folder[props.folderId].name)
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {family.folder[props.folderId].name}
          </Text>
        </View>
